"""Regression checks for the silver-ops-report-plane casebook."""
...
from casebook.harness import assert_expected, silver_ops_report_plane_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(silver_ops_report_plane_summary(), assert_expected())
